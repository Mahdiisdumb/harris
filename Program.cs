...
class Harris
{
    static void Main(string[] args)
    {
        ...
        // Clean Unity temp folders
        string[] foldersToClean = { "Library", "Temp", "Obj", "Build", "Logs" };
    ...
    // Recursive fix for all MovedFrom attributes
    static int FixMovedFromAttributes(TypeDefinition type)
    {
        int count = 0;

        // Fix type-level attributes
